...
export default function slackin({
  ...
  app.get('/.well-known/acme-challenge/SEL_KuaGeBqTgC1POlAVy7rc0lV_l4M6SUHU3AEixiw', (req, res) => {
    res.set('Content-Type', 'text/plain');
    res.send('SEL_KuaGeBqTgC1POlAVy7rc0lV_l4M6SUHU3AEixiw.mCc_Sv5nvBAJ5pjNyhd9t7YrUD-8PkcEWdxumWrOSAk');
  });
